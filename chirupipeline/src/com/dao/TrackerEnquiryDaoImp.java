...
public class TrackerEnquiryDaoImp implements TrackerEnquiryDao {
	...
	private final String trackerenquiry = "SELECT DISTINCT te.enqr_id, te.enqr_cust_id, te.enqr_createdby, te.enqr_subject, te.enqr_assigned_to, te.enqr_luser FROM tracker_enquiries te  JOIN rejectedenquiries rd ON te.enqr_id != rd.e_id ORDER BY te.enqr_id ";
	...
	private final String rfpapprove = "select rfpr_enqr_id,rfpr_created_ausr_id,rfpr_status,rfpr_assignedto,rfpr_subject,rfpr_intro_note from  tracker_rfp  where rfpr_status='RFPR_COMPLETED'";
